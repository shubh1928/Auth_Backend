...
import com.proj.auth.auth.entities.RefreshToken;
import com.proj.auth.auth.entities.User;
import com.proj.auth.auth.payload.LoginRequest;
import com.proj.auth.auth.payload.RefreshTokenRequest;
import com.proj.auth.auth.payload.TokenResponse;
import com.proj.auth.auth.payload.UserDto;
import com.proj.auth.auth.repositories.RefreshTokenRepository;
import com.proj.auth.auth.repositories.UserRepository;
import com.proj.auth.auth.services.impl.CookieService;
import com.proj.auth.auth.services.impl.JwtService;
import com.proj.auth.auth.services.AuthService;
...
public class AuthController {
    ...
    @PostMapping("/login")
     ...
     //API for reneving access and refresh tokens
     @PostMapping("/refresh")
    ...
    // All the below stuff is for getting the refresh token
